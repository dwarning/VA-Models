...
<Components>
  ...
  <.CUSTOMSIM CUSTOM1 1 50 580 0 51 0 0 "\npre_osdi vbic_1p3.osdi" 1 "" 0 "custom#ac1#.plot;custom#ac1#.print" 0>
  <BJT_SPICE Q1 1 190 210 -181 0 1 1 "4" 1 "npn" 1 "X" 1 "npn13G2 nx=8" 1 "" 0 "" 0 "" 0 "" 0>
  <SpiceInclude SpiceInclude1 1 80 510 -33 16 0 0 "../Modelcards/SG13G2_hbt_woStatistics.hsp.lib" 1 "" 0 "" 0 "" 0 "" 0>
  <R R2 1 300 150 15 -26 0 1 "0.7 Ohm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
</Components>
<Wires>
...
<Diagrams>
  <Rect 510 314 425 284 3 #c0c0c0 1 00 0 9.8e-08 1e-08 1e-07 1 -1.41459 1 4.29171 1 -0.00206609 0.005 0.0182178 315 0 225 0 0 0 "" "" "">
	<"ngspice/tran.v(out)" #0000ff 0 3 0 0 0>
	<"ngspice/tran.v(e)" #e5a50a 0 3 0 0 0>
