...
<Properties>
  <View=-34,-44,931,525,1.23548,0,0>
  <Grid=10,10,1>
  <DataSet=npn13G2_cje_cjc_cjs_vb.dat>
  <DataDisplay=npn13G2_cje_cjc_cjs_vb.dpl>
  <OpenDisplay=0>
  <Script=cgs_nmos.m>
  <RunScript=0>
  <showFrame=0>
...
<Components>
  ...
  <BJT_SPICE Q1 1 180 50 -26 34 0 0 "4" 1 "npn" 1 "X" 1 "npn13G2 nx=1" 1 "" 0 "" 0 "" 0 "" 0>
  <BJT_SPICE Q2 1 180 260 -26 34 0 0 "4" 1 "npn" 1 "X" 1 "npn13G2 nx=1" 1 "" 0 "" 0 "" 0 "" 0>
  ...
  <SpiceInclude SpiceInclude1 1 50 430 -33 16 0 0 "../Modelcards/SG13G2_hbt_woStatistics.hsp.lib" 1 "" 0 "" 0 "" 0 "" 0>
</Components>
<Wires>
  <210 50 240 50 "" 0 0 0 "">
  <180 10 180 20 "" 0 0 0 "">
...
<Diagrams>
  <Rect 650 180 240 160 3 #c0c0c0 1 00 1 -2 0.5 0.5 1 1.5e-15 5e-16 2.68838e-15 1 -1 1 1 315 0 225 1 0 0 "" "" "">
