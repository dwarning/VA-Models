...
<Components>
  ...
  <MOS_SPICE X2 1 520 100 -211 -26 0 3 "X" 0 "4" 0 "pmos" 0 "pch90 w=10u l=0.1u nf=4" 1 "+ ad=10p as=10p" 1 "+ pd=14u ps=14u" 1 "" 0 "" 0>
  <MOS_SPICE X3 1 770 100 -211 -26 0 3 "X" 0 "4" 0 "pmos" 0 "pch90 w=10u l=0.1u nf=4" 1 "+ ad=10p as=10p" 1 "+ pd=14u ps=14u" 1 "" 0 "" 0>
  <Vdc Vg 1 100 170 31 -14 0 3 "1" 1>
  <Vdc Vg_dsb 1 280 170 3 3 1 1 "0" 1>
