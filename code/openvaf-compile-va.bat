...
openvaf.exe -D__NGSPICE__ -o hicumL2V2p4p0.osdi ..\code\hicum2\vacode\hicumL2V2p4p0.va
openvaf.exe -D__NGSPICE__ -o hicumL2.osdi ..\code\hicum2\vacode\hicumL2_v310.va
