...
openvaf.exe -D__NGSPICE__ -o angelov.osdi ../angelov/vacode/angelov.va
openvaf.exe -D__NGSPICE__ -o angelov_gan.osdi ../angelov/vacode/angelov_gan.va
...
openvaf.exe -D__NGSPICE__ -o bsimbulk.osdi ../bsimbulk/vacode/bsimbulk.va
...
openvaf.exe -D__NGSPICE__ -o ekv26.osdi ../ekv/vacode/ekv26.va
openvaf.exe -D__NGSPICE__ -o epfl_hemt.osdi ../EPFL-HEMT/vacode/epfl_hemt.va
...
openvaf.exe -D__NGSPICE__ -o hicumL0_v2p1p0.osdi ../hicum0/vacode/hicumL0_v2p1p0.va
...
openvaf.exe -D__NGSPICE__ -o hisimhv.osdi ../hisimhv/vacode/hisimhv.va
openvaf.exe -D__NGSPICE__ -o hisimsoi.osdi ../hisimsoi/vacode/hisimsoi.va
openvaf.exe -D__NGSPICE__ -o hisimsotb.osdi ../hisimsotb/vacode/hisimsotb.va
openvaf.exe -D__NGSPICE__ -o igbt3.osdi ../IGBT/vacode/igbt3.va
...
openvaf.exe -D__NGSPICE__ -o bjt505.osdi ../mextram/vacode/bjt505.va
openvaf.exe -D__NGSPICE__ -o bjt505t.osdi ../mextram/vacode/bjt505t.va
openvaf.exe -D__NGSPICE__ -o mosvar.osdi ../MOSVAR/vacode/mosvar.va
openvaf.exe -D__NGSPICE__ -o mvsg_cmc.osdi ../mvsg/vacode/mvsg_cmc_3.2.0.va
openvaf.exe -D__NGSPICE__ -o psp102.osdi ../psp102/vacode/psp102.va
openvaf.exe -D__NGSPICE__ -o juncap200.osdi ../psp103/vacode/juncap200.va
